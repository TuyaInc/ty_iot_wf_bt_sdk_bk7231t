 ...
 * @Others: none
 */
BOOL_T tuya_hard_judge_key_pin(IN TY_GPIO_PORT_E key_touch_pin)
{
    if (key_touch_pin > GPIO_PIN_MAX)
    {
        PR_ERR("tuya_hard_judge_key_pin param pin_num is not exit,error_pin_num:%d",key_touch_pin);
        return FALSE;
    }
